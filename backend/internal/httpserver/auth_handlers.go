...
type patchMeRequest struct { DisplayName *string `json:"displayName"`; AvatarURL *string `json:"avatarUrl"`; ProfileVisibility *string `json:"profileVisibility"`; Language *string `json:"language"` }
